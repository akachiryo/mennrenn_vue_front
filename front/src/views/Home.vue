<template>
    ...
    >
      ...
      >
        <v-card class="ma-4" max-width="310">
          ...
          <v-card-text class="text--primary text-truncate" style="min-height: 64px;">
                  <v-chip
                          class="ma-1"
                          color="orange"
                          text-color="white"
  ...
  <div>
      <h1
      class="home-room text-center mt-10 mb-10"
      color="#99ffff">
      ...
      <fade-in-left>
        <v-row class="mt-10">
          ...
          <v-col xs="12"> 
            ...
            <p>ユーザーログインから部屋を作成するまで、5分もかかりません。自分の条件に合う部屋があれば、より短い時間で練習を始めることができます。</p>
          </v-col>
        </v-row>
      </fade-in-left>
      <fade-in-right>
        <v-row  class="mt-10">
          ...
          <v-col xs="12">
            ...
            <p>部屋にタグを付けることで、細かい条件を指定できます。「顔出し」「時間」「業界」様々な条件を付けることで、最適な練習相手を探すことができます。</p>
          </v-col>
        </v-row>
      </fade-in-right>
      <fade-in-left>
        <v-row  class="mt-10">
          ...
          <v-col xs="12">
            ...
            <p>リモートワークなど働き方が変化している昨今、面接にもその影響が表れています。面接本番と同じ環境で練習ができます。</p>
          </v-col>
        </v-row>
      </fade-in-left>
    </div>
